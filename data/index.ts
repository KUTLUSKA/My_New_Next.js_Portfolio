...
export const navItems = [
  ...
  export const gridItems = [
    ...
    {
      id: 3,
      title: "Teknik bilgi birikimim",
      description: "Kendimi sürekli olarak daha ileri taşımak için çabalıyorum.",
      className: "lg:col-span-2 md:col-span-3 md:row-span-2",
      imgClassName: "",
      titleClassName: "justify-center",
      img: "",
    ...
    {
      id: 6,
      title: "Aklınızdaki proje için iş birliği yapmak ister misiniz?",
      description: "",
      className: "lg:col-span-2 md:col-span-3 md:row-span-1",
      imgClassName: "",
  ...
  export const projects = [
    ...
    {
      id: 3,
      title: "NLP Music Recommendation Website",
